...
<div id="search-div" style="text-align: center;">
	<form method="get">
		<input type="text" name="keyword" style="width:300px;" value="<@search_keyword />" />
		<input type="submit" value=' 搜  索 '/>
	</form>
</div>

<#if (keyword?has_content && postPage.result?size == 0)>
<h3>未找到于关键字 <font color="red"><@search_keyword /></font> 相关的结果</h3>
</#if>
...
<div class="pager">
	<span class="pager-list">
		<form id="postForm" name="postForm">
			...
			<input type="hidden" name="keyword" style="width:300px;" value="<@search_keyword />" />
