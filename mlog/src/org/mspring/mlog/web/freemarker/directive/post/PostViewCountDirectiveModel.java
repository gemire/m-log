 ...
 * @TODO
 */
public class PostViewCountDirectiveModel extends AbstractDirectiveModel {
    private static final Logger log = Logger.getLogger(PostViewCountDirectiveModel.class);

    public static final String KEY = "post_view_count";
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
        ...
        if (post.getCommentCount() != null) {
            count = post.getViewCount().toString();
        }
