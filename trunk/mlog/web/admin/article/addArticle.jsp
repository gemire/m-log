...
<%@ include file="../includes/header.jsp" %>
	...
	<body>
		<div id="divMain">
			<div class="Header"><ss:text name="articleedit.createtitle" /></div>
			<div class="SubMenu"></div>
			<div class="form">
				<form action="<%=path %>/admin/article/doCreateArticle.action" id="articleForm" name="articleForm" method="post">
					<!-- hidden -->
					<input type="hidden" name="article.level" value="1" />
					<input type="hidden" name="article.url" value="" />
					<input type="hidden" name="article.modifyTime" value="" />
					<input type="hidden" name="article.commentNums" value="0" />
					<input type="hidden" name="article.viewNums" value="0" />
					<input type="hidden" name="article.isDel" value="0" />
					...
					<table class="gridtable" width='100%' style='padding: 0px; margin: 0px;' cellspacing='0' cellpadding='0'>
						<tr>
							...
							<td style="width: 85%">
								<input type="text" name="article.title" style="width: 460px;" class="textfield" validate="{required:true, messages:{required:'文章标题不能为空'}}" /><span class="spanerror">(*)</span>
							</td>
						</tr>
						<tr>
							<td style='width: 5%'>
							...
							<td style="width: 85%">
								<input type="text" id="category_name_input" style="width: 460px;" readonly="readonly" class="textfield" />
								<input type="hidden" name="categoryIds" id="category_id_input" />
						...
						<tr>
							...
							<td style="width: 85%">
								<input type="text" id="tag_name_input" style="width: 460px;" readonly="readonly" class="textfield" />
								<input type="hidden" name="tagIds" id="tag_id_input" />
						...
						<tr>
							...
							<td style="width: 85%">
								...
								<input type="hidden" name="article.isTop" value="0" id="hidIsTop" />
							</td>
						</tr>
						<tr>
							<td colspan="2">
								<textarea id="article_content" name="article.content" style="height:200pt;width:100%;" validate="{required:true, messages:{required:'文章内容不能为空'}}"></textarea>
							</td>
						</tr>
						<tr>
							<td colspan="2">
								<textarea id="article_intro" name="article.intro" style="height:80pt;width:100%;"></textarea>
							</td>
						</tr>
						<tr>
							<td colspan="2">
