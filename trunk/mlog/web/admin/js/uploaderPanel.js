...
mspring.UploadPanel = function(cfg){
	this.width = 510;
	this.height = 300;
	Ext.apply(this,cfg);	
	...
	mspring.UploadPanel.superclass.constructor.call(this,{				
		tbar : [
			{id:'addFileButton', text:'添加文件',iconCls:'add_pic',ref:'../addBtn'},'-',
			{id:'xxxtest', text:'上传',ref:'../uploadBtn',iconCls:'upload',handler:this.startUpload,scope:this},'-',
			{text:'停止上传',ref:'../stopBtn',iconCls:'delete',handler:this.stopUpload,scope:this,disabled:true},'-',
			{text:'删除所有',ref:'../deleteBtn',iconCls:'cancel',handler:this.deleteAll,scope:this},'-'
		],
		layout : 'fit',
		items : [this.gp],
		listeners : {
			'afterrender':function(){
				...
				this.swfupload = new SWFUpload(Ext.apply(this.setting,{
					...
					button_placeholder_id : 'addFileButton',
					button_text : '选择图片'
				}));
...
Ext.extend(mspring.UploadPanel,Ext.Panel,{
...
Ext.reg('uploadPanel',mspring.UploadPanel);