...
import org.mspring.platform.security.support.ClassLoaderUtils;
...
public class SecurityConfigImpl implements SecurityConfig {
    ...
    private void configureParameters(Element root) {
        ...
        if (globalParams.get("loginform.password.key") != null)
            this.loginformPasswordKey = ((String) globalParams.get("loginform.password.key"));
    }
