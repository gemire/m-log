 ...
 * @TODO 获取文章作者名称
 */
public class PostAuthorNameDirectiveModel extends AbstractDirectiveModel {
    private static final Logger log = Logger.getLogger(PostAuthorNameDirectiveModel.class);
