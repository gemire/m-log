 ...
 * @TODO
 */
public class CommentContentDirectiveModel extends AbstractDirectiveModel {
    private static final Logger log = Logger.getLogger(CommentContentDirectiveModel.class);

    public static final String KEY = "comment_content";
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
        ...
        env.getOut().append(comment.getContent());
    }
