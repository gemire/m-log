...
public class ImagingUtils {
    public static void main(String[] args) throws ImageReadException, IOException {
        metadataExample(new File("D:\\img_F028c_small.jpg"));
    }
    ...
    private static void printTagValue(final JpegImageMetadata jpegMetadata, final TagInfo tagInfo) throws ImageReadException {
        final TiffField field = jpegMetadata.findEXIFValueWithExactMatch(tagInfo);
        if (field == null) {
            System.out.println(tagInfo.name + ": " + "Not Found.");
        } else {
            System.out.println(tagInfo.name + ": " + field.getValue());
        }
    }
