...
import org.mspring.msns.entity.JobLog;
...
public class JobLogServiceImpl extends AbstractServiceSupport implements JobLogService {
     ...
     * 
     * @see
     * org.mspring.msns.service.JobLogService#createJobLog(org.mspring.msns.
     * entity.JobLog)
     */
    @Override
     ...
     * 
     * @see
     * org.mspring.msns.service.JobLogService#getLastestExecute(java.lang.Long)
     */
    @Override
     ...
     * 
     * @see
     * org.mspring.msns.service.JobLogService#findJobLog(org.mspring.platform
     ...
     * (non-Javadoc)
     * 
     * @see org.mspring.msns.service.JobLogService#removeJobLog(int)
     */
    @Override
