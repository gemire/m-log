...
import org.mspring.msns.entity.Stat;
...
public class StatServiceImpl extends AbstractServiceSupport implements StatService {
     ...
     * (non-Javadoc)
     * 
     * @see org.mspring.msns.service.StatService#getPostCount()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.mspring.msns.service.StatService#getCommentCount()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.mspring.msns.service.StatService#getClickCount()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.mspring.msns.service.StatService#updatePostCount()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.mspring.msns.service.StatService#updateCommentCount()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.mspring.msns.service.StatService#updateClickCount()
     */
    @Override
