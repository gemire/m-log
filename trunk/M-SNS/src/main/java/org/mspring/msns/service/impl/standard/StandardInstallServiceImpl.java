 ...
 * 
 */
package org.mspring.msns.service.impl.standard;
...
import org.mspring.msns.service.impl.AbstractInstallService;
...
public class StandardInstallServiceImpl extends AbstractInstallService {
     ...
     * (non-Javadoc)
     * 
     * @see org.mspring.msns.service.InstallService#initTreeItems()
     */
    @Override
    public void initTreeItems() {
        ...
        items.add(new TreeItem("115010", "反垃圾", "115", "/admin/comment/spam/config", TreeItem.Type.TAB, false));
        ...
        items.add(new TreeItem("815005005", "列表", "815005", "/admin/spider/rule/list", TreeItem.Type.TAB, true));
        items.add(new TreeItem("815005010", "增加", "815005", "/admin/spider/rule/create", TreeItem.Type.TAB, false));
        items.add(new TreeItem("815005015", "修改", "815005", "/admin/spider/rule/edit", TreeItem.Type.TAB, false));
        items.add(new TreeItem("815005020", "采集", "815005", "/admin/spider/rule/run_view", TreeItem.Type.TAB, false));
        items.add(new TreeItem("815010", "文章管理", "815", "", TreeItem.Type.TREE_ITEM, true));
        items.add(new TreeItem("815010005", "列表", "815010", "/admin/spider/post/list", TreeItem.Type.TAB, true));
