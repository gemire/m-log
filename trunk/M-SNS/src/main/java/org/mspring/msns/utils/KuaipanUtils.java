 ...
 * 
 */
package org.mspring.msns.utils;

import org.mspring.msns.core.ServiceFactory;
import org.mspring.platform.api.kuaipan.MKuaipanAPI;
import org.mspring.platform.api.kuaipan.client.exception.KuaipanException;
import org.mspring.platform.api.kuaipan.client.model.AccessToken;
import org.mspring.platform.api.kuaipan.client.model.TokenPair;
...
public class KuaipanUtils {
    ...
    public static synchronized MKuaipanAPI getApi() {
        // String consumer_key =
        // ServiceFactory.getOptionService().getOption("consumer_key");
        // String consumer_secret =
        // ServiceFactory.getOptionService().getOption("consumer_secret");
        ...
        if (api == null) {
            ...
            api = new MKuaipanAPI(session, ServiceFactory.getOptionService().getOption("siteurl"));
    ...
    // OauthSession session = new OauthSession("xcJs0tWpPdBhGgl0",
    // "xcJs0tWpPdBhGgl0", OauthSession.Root.APP_FOLDER);
    ...
    // String consumer_key =
    // ServiceFactory.getOptionService().getOption("api_kuaipan_key");
    // String consumer_secret =
    // ServiceFactory.getOptionService().getOption("api_kuaipan_secret");
    ...
    public static AccessToken loadAuthFile() {
        // String authKey =
        // ServiceFactory.getOptionService().getOption("api_kuaipan_access_key");
        // String authSecret =
        // ServiceFactory.getOptionService().getOption("api_kuaipan_access_secret");
