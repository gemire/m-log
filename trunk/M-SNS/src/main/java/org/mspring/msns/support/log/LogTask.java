 ...
 * 
 */
package org.mspring.msns.support.log;
...
import org.mspring.msns.service.LogService;
...
public class LogTask extends AbstractTask {
    ...
    protected void doTask(Map<Object, Object> paramMap) throws Exception {
        ...
        org.mspring.msns.entity.Log log = new org.mspring.msns.entity.Log();
...
class ExclusionStrategyEntity implements ExclusionStrategy {
    ...
    public boolean shouldSkipField(FieldAttributes f) {
        // TODO Auto-generated method stub
        if (f.getDeclaredClass().getName().indexOf("org.mspring.msns") != -1 || f.getDeclaredClass().isAssignableFrom(Collection.class) || f.getDeclaredClass().isAssignableFrom(Set.class)) {
            return true;
        }
