...
import org.mspring.msns.support.resolver.PathParam;
import org.mspring.msns.support.resolver.QueryParam;
import org.mspring.msns.web.query.PostQueryCriterion;
...
public class Admin_PostWidget extends AbstractAdminWidget {
    private static final Logger log = Logger.getLogger(Admin_PostWidget.class);
