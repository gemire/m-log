...
import org.mspring.msns.web.query.TagQueryCriterion;
...
public class Admin_TagWidget extends AbstractAdminWidget {
    private static final Logger log = Logger.getLogger(Admin_TagWidget.class);
