...
import org.mspring.msns.service.MailService;
...
import org.mspring.platform.api.akisment.Akismet;
...
public class CommentServiceImpl extends AbstractServiceSupport implements CommentService {
     ...
     * 
     * @see
     * org.mspring.msns.service.CommentService#createComment(org.mspring.msns
     * .entity.Comment)
     */
    @Override
     ...
     * 
     * @see
     * org.mspring.msns.service.CommentService#deleteComment(java.lang.Long[])
     */
    @Override
     ...
     * 
     * @see
     * org.mspring.msns.service.CommentService#findCommentsByPost(java.lang.
     * Long)
     */
    @Override
     ...
     * 
     * @see
     * org.mspring.msns.service.CommentService#getCommentById(java.lang.Long)
     */
    @Override
     ...
     * 
     * @see
     * org.mspring.msns.service.CommentService#findComment(java.lang.String,
     * java.lang.Object[])
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.mspring.msns.service.CommentService#getRecentComment(int)
     */
    @Override
     ...
     * 
     * @see
     * org.mspring.msns.service.CommentService#findComment(org.mspring.platform
     ...
     * (non-Javadoc)
     * 
     * @see org.mspring.msns.service.CommentService#approved(java.lang.Long[])
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.mspring.msns.service.CommentService#spam(java.lang.Long[])
     */
    @Override
        ...
        for (Long id : ids) {
            ...
            try {
                ...
                if (StringUtils.isNotBlank(akismet_key)) {
                    Akismet akismet = new Akismet(akismet_key, optionService.getOption("siteurl"));
     ...
     * (non-Javadoc)
     * 
     * @see org.mspring.msns.service.CommentService#recycle(java.lang.Long[])
     */
    @Override
     ...
     * 
     * @see
     * org.mspring.msns.service.CommentService#commentReplyNotice(java.lang.
     * Long)
     */
    @Override
     ...
     * 
     * @see
     * org.mspring.msns.service.CommentService#commentNotice(org.mspring.msns
     * .entity.Comment)
     */
    @Override
