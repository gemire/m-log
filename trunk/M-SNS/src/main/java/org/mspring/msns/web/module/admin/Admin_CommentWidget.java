...
import org.mspring.msns.web.query.CommentQueryCriterion;
...
public class Admin_CommentWidget extends AbstractAdminWidget {

    private static final Logger log = Logger.getLogger(Admin_CommentWidget.class);
