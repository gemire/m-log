...
//import org.mspring.msns.service.cache.CacheService;
//import org.mspring.msns.service.cache.DefaultCacheService;
...
//
//    @Before("execution(* org.mspring.msns.service.security.*.find*(..)) || execution(* org.mspring.msns.service.security.*.get*(..)) || execution(* org.mspring.msns.service.security.*.has*(..)) || execution(* org.mspring.msns.service.security.*.load*(..))")
...
//    }
//
//    @AfterReturning(("execution(* org.mspring.msns.service.security.*.create*(..)) || execution(* org.mspring.msns.service.security.*.update*(..)) || execution(* org.mspring.msns.service.security.*.delete*(..)) || execution(* org.mspring.msns.service.security.*.remove*(..)) || execution(* org.mspring.msns.service.security.*.set*(..))"))
