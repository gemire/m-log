 ...
 * 
 */
package org.mspring.platform.cache.web.filter;
...
public abstract class Filter implements javax.servlet.Filter {
    ...
    /**
     * Most {@link Throwable}s in Web applications propagate to the user.
     * Usually they are logged where they first happened. Printing the stack
     * trace once a {@link Throwable} as propagated to the servlet is sometimes
     ...
     * 
     * @throws IOException
     *             if an IOException occurs during this method it will be
     ...
     */
    private void logThrowable(final Throwable throwable, final HttpServletRequest httpRequest) throws ServletException, IOException {
    ...
    /**
     * Destroys the filter. Calls template method {@link #doDestroy()} to
     * perform any filter specific destruction tasks.
     */
     ...
     */
    protected abstract void doFilter(final HttpServletRequest httpRequest, final HttpServletResponse httpResponse, final FilterChain chain) throws Throwable;
