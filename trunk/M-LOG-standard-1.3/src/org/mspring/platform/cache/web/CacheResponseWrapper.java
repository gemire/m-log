...
import org.mspring.platform.cache.web.Header.Type;
 ...
 * @TODO
 */
public class CacheResponseWrapper extends HttpServletResponseWrapper implements Serializable {

    /**
     * 
     */
    private static final long serialVersionUID = -6493677828225009648L;
    ...
    /**
     * Creates a CacheResponseWrapper
     */
    public CacheResponseWrapper(final HttpServletResponse response, final OutputStream outstr) {
        super(response);
