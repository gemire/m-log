...
import org.mspring.mlog.web.dwr.DWRPush;
...
public class Admin_SpiderRuleWidget extends AbstractSpiderWidget {
    ...
    public void spider(@RequestParam(required = false) Long id, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        DWRPush.sendMessage("开始...");
        DWRPush.sendMessage("开始获取列表：" + rule.getUrl());
