...
<form id="mailForm" name="mailForm" method="post" action="${base}/admin/setting/saveMail">
	...
	<table class="infotable">
		...
		<tr>
			...
			<td>
				<input type="input" class="textinput" style="width:95%;" name="smtp_password" value="${smtp_password!""}" validate="{maxlength:100, messages:{maxlength:'SMTP身份验证密码最大长度不能超过{0}'}}"/>
			</td>
			<td class="fieldnotice" style="width:300px;">规则：最大长度100</td>
		</tr>
		<tr>
