 ...
 *
 */
package org.mspring.mlog.api.rss.feed.synd;

import org.mspring.mlog.api.rss.feed.impl.ObjectBean;
import org.mspring.mlog.api.rss.feed.module.*;
import org.mspring.mlog.api.rss.feed.module.impl.ModuleUtils;
import org.mspring.mlog.api.rss.feed.synd.impl.URINormalizer;
import org.mspring.mlog.api.rss.feed.impl.CopyFromHelper;
...
public class SyndEntryImpl implements Serializable,SyndEntry {
    ...
    /* (non-Javadoc)
     * @see org.mspring.mlog.api.rss.feed.synd.SyndEntry#setAuthors(java.util.List)
     */
    ...
    /* (non-Javadoc)
     * @see org.mspring.mlog.api.rss.feed.synd.SyndEntry#setContributors(java.util.List)
     */
