...
public class Base64 {
     ...
     * @return encoded string.
     * @throws java.lang.IllegalArgumentException thrown if the given byte array was not valid org.mspring.mlog.api.rss.io.impl.Base64 encoding.
     *
     */
    ...
    /**
     * Dencodes a org.mspring.mlog.api.rss.io.impl.Base64 byte array.
     * <p>
    ...
    public static byte[] decode(byte[] eData) {
        ...
        for (int i = 0; i < eData.length; i += 4) {
            if ((i + 3) > eData.length) {
                throw new IllegalArgumentException("byte array is not a valid org.mspring.mlog.api.rss.io.impl.Base64 encoding");
            }
