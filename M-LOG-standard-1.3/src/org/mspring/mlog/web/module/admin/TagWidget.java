...
public class TagWidget extends AbstractAdminWidget {
	...
	@RequestMapping("/list")
	public String listTag(@ModelAttribute Page<Tag> tagPage,
			@ModelAttribute Tag tag, @QueryParam Map queryParams,
		...
		tagPage = tagService.findTag(tagPage,
				new TagQueryCriterion(queryParams));
		model.addAttribute("tagPage", tagPage);
		return "/admin/tag/listTag";
	}

	@RequestMapping("/delete")
	public String deleteTag(@RequestParam(required = false) Long[] id,
			@ModelAttribute Page<Tag> tagPage, @ModelAttribute Tag tag,
	...
	@RequestMapping("/edit")
	public String editTagView(@RequestParam(required = false) Long id,
			HttpServletRequest request, HttpServletResponse response,
			Model model) {
		  if (id == null) {
	...
	public String editTagSave(@ModelAttribute Tag tag,
			HttpServletRequest request, HttpServletResponse response,
			Model model) {
	...
	public String createTagView(@ModelAttribute Tag tag,HttpServletRequest request, HttpServletResponse response,
			Model model){
