 ...
 * @TODO
 */
public class CommentAuthorUrlDirectiveModel extends AbstractDirectiveModel {
    private static final Logger log = Logger.getLogger(CommentAuthorUrlDirectiveModel.class);

    public static final String KEY = "comment_author_url";
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
        ...
        env.getOut().append(comment.getUrl());
    }
