...
import org.mspring.mlog.api.rss.feed.atom.Generator;
import org.mspring.mlog.api.rss.feed.atom.Link;
import org.mspring.mlog.api.rss.feed.atom.Person;
import org.mspring.mlog.api.rss.io.FeedException;
import org.mspring.mlog.api.rss.io.WireFeedInput;
import org.mspring.mlog.api.rss.io.WireFeedOutput;
...
public class Atom10Parser extends BaseWireFeedParser {
    ...
    private Feed parseFeedMetadata(String baseURI, Element eFeed) {
        org.mspring.mlog.api.rss.feed.atom.Feed feed =
            new org.mspring.mlog.api.rss.feed.atom.Feed(getType());
