 ...
 * @TODO 获取分类链接
 */
public class CatalogUrlDirectiveModel extends AbstractDirectiveModel {
    private static final Logger log = Logger.getLogger(CatalogUrlDirectiveModel.class);

    public static final String KEY = "catalog_url";
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
        ...
        //env.getOut().append(base + "/catalog/" + catalog.getName());
        env.getOut().append(base + "/catalog/catalog-" + catalog.getId() + ".html");
    }
