 ...
 * @TODO
 */
public class CommentIdDirectiveModel extends AbstractDirectiveModel {
    private static final Logger log = Logger.getLogger(CommentIdDirectiveModel.class);

    public static final String KEY = "comment_id";
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
        ...
        env.getOut().append(comment.getId().toString());
    }
