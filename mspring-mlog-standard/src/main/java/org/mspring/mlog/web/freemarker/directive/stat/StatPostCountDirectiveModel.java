 ...
 * @TODO
 */
public class StatPostCountDirectiveModel extends AbstractDirectiveModel {
    private static final Logger log = Logger.getLogger(StatPostCountDirectiveModel.class);

    public static final String KEY = "stat_post_count";
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
        // TODO Auto-generated method stub
        String value = ServiceFactory.getStatService().getPostCount();
