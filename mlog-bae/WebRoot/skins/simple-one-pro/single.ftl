			...
			<div class="main-content">
				<div class="main-posts main-item">
					<div class="post-header">
						...
						<div class="post-meta">
	        				发表于<@post_time /><span class="split">|</span>
	        				<span class="split">|</span><a href="<@post_url/>" id="uyan_count_unit">0条评论</a><span class="split">|</span>
				...
				<#if post.commentStatus == 'open'>
					<div class="comment" style="margin:10px;">
						...
						<script type="text/javascript" id="UYScript" src="http://v1.uyan.cc/js/iframe.js?UYUserId=1680304" async=""></script>
						<!-- UY END -->
