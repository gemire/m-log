...
import org.mspring.mlog.web.common.gravatar.GravatarUtils;
 ...
 * @TODO
 */
public class CommentGravatarDirectiveModel extends AbstractDirectiveModel {
    private static final Logger log = Logger.getLogger(CommentGravatarDirectiveModel.class);

    public static final String KEY = "comment_gravatar";
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
        ...
        env.getOut().append(GravatarUtils.getGravatarImage(email));
    }
